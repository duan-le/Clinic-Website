...
CREATE TABLE `product_receipt` (
  ...
  KEY `fk_receipt_number_pr_idx` (`receipt_number`),
  CONSTRAINT `fk_product_id_pr` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`),
  CONSTRAINT `fk_receipt_number_pr` FOREIGN KEY (`receipt_number`) REFERENCES `receipt` (`number`)
...
INSERT INTO `product_receipt` VALUES (1,2),(3,3);
